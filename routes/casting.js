...
router.post('/adicionar', function(req, res, next) {
  ...
  var dataNascimento = dateTime.create(dtnasc, 'd/m/Y');
  var dataNascimentoFormat = dataNascimento.format('Y-m-d');
  ...
  ' cas_busto, cas_cintura, cas_quadril, cas_etnia, cas_cabelo, ' +
    ...
    [tipo, nome, nomeart, genero, ano, terno, camisa, busto, cintura, quadril, etnia, cabelo, olhos, 
		peso, dataNascimentoFormat, rg, cpf, cnh, drt, endereco, altura, manequim, sapato, foto34, fotobody,
